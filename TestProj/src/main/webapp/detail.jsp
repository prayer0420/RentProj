	...
	<div class="product-layout">
		...
		<div class="product-details">
			...
			<div class="btn-box">
				...
				<button class="btn btn-rent" onclick="openRentalModal()">대여하기</button>
			</div>
		</div>
	</div>
	...
	<div class="tab-content">
		<div class="tab-pane show" id="info">
			<div class="description">
				...
				거래지역은 사당역, 서울대벤처타운역, 신림역 등 서울대 근처 우선이며, 직거래만 가능합니다.<br> 현금/계좌이체
				모두 가능하며, 제가 직접 대중교통을 이용해 거래합니다.
			</div>
		</div>
...
<script>
    ...
    tabItems.forEach(item => {
      item.addEventListener('click', () => {
        ...
        item.classList.add('active'dsfv);
