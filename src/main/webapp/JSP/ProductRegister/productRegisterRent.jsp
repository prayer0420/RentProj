	...
	<form class="container">
		...
		<div class="container-category">
			<select name="" id="" class="category-list">
				...
				<option value="fashion">의류/패션/악세사리</option>
				<option value="pc">PC용품/디지털</option>
				<option value="elec">가전제품</option>
				<option value="beuty">뷰티/미용</option>
				<option value="camping">캠핑/스포츠/레져</option>
				<option value="life">생활/주방용품</option>
				<option value="feature">가구/인테리어</option>
				<option value="baby">유아동/출산</option>
				<option value="animal">애완동물용품</option>
				<option value="etc">기타</option>
			</select> <input type="text" id="title" placeholder="제목을 입력하세요">
		</div>
		...
		<div class="container-security">
			<h4>보증금</h4>
			<input type="text" class="rent-security" placeholder="보증금 가격" id="secPrice">
		</div>
		...
		<div class="container-delivery">
			...
			<input type="radio" id="deliv" name="delivery" class="delivery-radio" id="deliveryPrice">
		...
		<div class="container-prodstate">
			...
			<div class="modal-prodState">
				<div class="modal-prodState-body">
					...
					<label for="state1" class="state-label">새상품(미사용)</label> <input
						type="radio" id="state2" name="state" class="state-radio">
					<label for="state2" class="state-label">사용감 적음</label> <input
						type="radio" id="state3" name="state" class="state-radio">
					<label for="state3" class="state-label">사용감 많음</label> <input
						type="radio" id="state4" name="state" class="state-radio">
