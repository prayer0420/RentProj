		...
		<div class="order-container">
			...
			<div class="order-box">
				...
				<div class="payment-total">
					<span>총 결제 금액</span> <span>${product.salePrice + product.deliveryPrice}원</span>
				</div>
			</div>
			...
			<button class="pay-button" onclick="requestPayment()">${product.salePrice + product.deliveryPrice}원
				결제하기</button>
		</div>
