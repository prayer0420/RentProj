...
<script type="text/javascript">
		...
		$(document).ready(function () {
		  ...
		  $("#submitInvoiceBtn").on("click", function () {
			    ...
			    const reDeliveryComp = $("#reDeliveryComp").val();
			    const reInvoiceNo = $("#reInvoiceNo").val();
			    const redirectUrl = $("#redirectUrl").val(); // 리다이렉트용 URL
		
		    $.ajax({
		        type: "POST",
		        url: "/rent/reInvoiceSetting", // 서블릿 매핑 경로
		        data: {
		            orderNo: orderNo,
		            reDeliveryComp: reDeliveryComp,
		            reInvoiceNo: reInvoiceNo
		        },
