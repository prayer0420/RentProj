...
//		Integer memberNo = Integer.parseInt(multi.getParameter("memberNo"));
		...
		Product product = new Product(categoryNo, title, content, imgList[0],imgList[1],imgList[2],imgList[3],imgList[4],deliveryAddr ,tradeType, memberNo,latitude,longitude);
