...
//		Integer memberNo = Integer.parseInt(multi.getParameter("memberNo"));
		...
		Product product= new Product(categoryNo, title, content, state, img1,img2,img3,img4,img5, deliveryAddr, deliveryPrice, tradeType, secPrice, memberNo, startDate, endDate, rentPrice, deliveryStatus);			
