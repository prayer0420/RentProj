...
//		Integer memberNo = Integer.parseInt(multi.getParameter("memberNo"));
		...
		Product product = new Product(categoryNo, title, content, state, imgList[0],imgList[1],imgList[2],imgList[3],imgList[4], deliveryAddr, deliveryPrice, tradeType, secPrice, memberNo, startDate, endDate, rentPrice, salePrice, deliveryStatus);
